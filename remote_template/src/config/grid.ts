...
export const AG_GRID_LOCALE_RU = {
  ...
  rowGroupColumnsEmptyMessage: 'Перенесите сюда название колонки для группирования',
  ...
  pivotColumnsEmptyMessage: 'Перетащите сюда, чтобы задать заголовки столбцам',
